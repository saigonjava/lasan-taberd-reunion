      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="md:col-span-2">
            ...
            <div className="mt-4 pt-4 border-t border-slate-800 max-w-xs space-y-2">
              <p className="text-slate-500 text-xs uppercase tracking-wider mb-1">Website Admin Contact:<br />
              <br></br><span className="text-white">Phillip Vinh Nguyen</span></p>
        ...
        <div className="mt-10 pt-6 border-t border-slate-800 flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <p className="text-slate-500 text-xs flex items-center gap-1">
            Made with <Heart size={12} className="text-rose-500" /> by Phillip Nguyen
          </p>
          {visits !== null && (
