...
const RAW = [
  ...
  ['Lê Kim Tuấn', 'Sài Gòn', 'Việt Nam', 'Retired', 'le-kim-tuan.jpg'],
  ...
  ['Lương Huy Tuấn', 'Montreal', 'Canada', 'Retired', 'luong-huy-tuan.jpg'],
  ...
  ['Nguyễn Đức Vân', 'Orange County, CA', 'USA', 'Retired', 'nguyen-duc-van.jpg'],
  ['Nguyễn Hoàng Tân', 'Whittier, CA', 'USA', 'Retired', 'nguyen-hoang-tan.jpg'],
  ...
  ['Nguyễn Văn Lộc', 'Sài Gòn', 'Việt Nam', 'Retired',],
  ['Nguyễn Văn Thọ', 'Sài Gòn', 'Việt Nam', 'Retired', 'nguyen-van-tho.jpg'],
  ...
  ['Nguyễn Minh Hoàng', 'France', 'Paris', 'Retired', 'nguyen-minh-hoang.jpg'],
